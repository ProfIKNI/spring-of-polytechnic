...
const MainMenuNavButton = ({ title, icon, route } : DetailedIcon) => {
    ...
    return (
        <Link to={route}
            className={`${window.innerWidth < 390 ? "w-28 h-28" : "w-32 h-32"} p-4 rounded-[2.5rem] bg-white/70 shadow-[0px_4px_8.7px_5px_rgba(255,255,255,0.25)] font-playFont flex flex-col items-center justify-end `}>
