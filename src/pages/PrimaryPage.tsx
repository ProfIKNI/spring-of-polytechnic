  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col items-center justify-end pb-4 z-10 text-center">
        <p
          className="text-[24px] text-[#30234F]"
        ...
        <h1
          className="text-[32px] font-bold drop-shadow-2xl text-[#30234F] mb-8"
          style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.2)" }}
        >
          ВСІМ ДОБРИЙ ДЕНЬ!
        </h1>
        <button
          onClick={handleClick}
          className="flex w-[85%] items-center text-[25px] font-bold justify-between gap-2 px-6 py-5 bg-[#0D0A26] text-white rounded-4xl hover:bg-[#1b1839] transition"
        >
          ГАЙДА З НАМИ!
      ...
      <img src={RocketImg} alt="Rocket" className="ml-26 pt-6 rocket" />
    </div>
  );
};
